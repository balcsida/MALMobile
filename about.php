...
<h1>About</h1>
<p>
The whole project on a little idea: make MAL compatible with mobile.<br>
I wanted to create a pure interface, which using the possibilities of responsive design.
</p>
